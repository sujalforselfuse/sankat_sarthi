  ...
  return (
    <div className="w-full flex flex-col items-center justify-center my-12">
      <div className="flex flex-col items-center justify-center 2xl:h-[150px] h-[100px] 2xl:w-[550px] sm:w-[470px]">
        ...
        <h1 className="2xl:text-7xl sm:text-4xl text-2xl text-[#007c7c] font-bold tracking-wide">
          Report For Help
        </h1>

        {/* Tagline */}

        <p className="2xl:text-2xl md:text-lg text-base text-[#8A8A8A] text-center m-auto">
      ...
      <form
        ...
        method="POST"
        className="2xl:w-[1000px] xl:w-[692px] lg:w-[662px]  w-full bg-white"
      >
        {/* Form Container */}
