...
const NearbyServices = () => {
  ...
  return (
    ...
    <div>
      ...
      <h1 className="2xl:text-7xl sm:text-4xl text-2xl text-[#007c7c] font-bold tracking-wide text-center my-10">Quick Access
      </h1>

      <div className="cursor-pointer flex justify-around gap-x-2 w-full p-6 py-16 bg-green-100 border-2 border-green-200 rounded-lg shadow hover:bg-gray-100">
