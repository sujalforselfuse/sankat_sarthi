...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="block w-full p-2 sm:p-6 border-2 border-green-200 rounded-lg shadow hover:bg-gray-100" style={{ background: `${getPHColor(currentPH)}` }}>
        ...
        <div className='flex md:flex-row flex-col gap-6 items-center justify-between'>
          ...
          <div className='flex flex-col justify-between md:items-start items-center'>
            ...
            <h5 className="mb-2 text-3xl font-bold tracking-tight text-green-900"> <span className='capitalize text-green-900'>Today's</span> Status</h5>
          ...
          <div className='flex flex-col justify-between items-center'>
            ...
            <p className="font-normal text-xl text-gray-700">Disaster Chances - <span className='text-green-900'>10%</span>
            </p>

            <p className="font-normal text-xl text-gray-700">Disaster Type - <span className='text-green-900 capitalize'>tsunami</span>
            </p>
      ...
      <div className='flex flex-wrap w-full justify-between gap-y-6'>
        ...
        <a href="tel:102" className="cursor-pointer flex justify-around gap-x-2 max-w-sm p-6 bg-green-100 border-2 border-green-200 rounded-lg shadow hover:bg-gray-100">
          ...
          <div>
            ...
            <h5 className="mb-2 text-3xl font-bold tracking-tight text-[#007c7c]">Ambulance</h5>

            <a href='tel:102' className="font-normal text-xl md:text-2xl text-gray-500">102</a>
        ...
        <a href="tel:101" className="cursor-pointer flex justify-around gap-x-2 max-w-sm p-6 bg-green-100 border-2 border-green-200 rounded-lg shadow hover:bg-gray-100">
          ...
          <div>
            ...
            <h5 className="mb-2 text-3xl font-bold tracking-tight text-[#007c7c]">Control Room</h5>

            <a href='tel:101' className="font-normal text-xl md:text-2xl text-gray-500">101</a>
        ...
        <a href="tel:011-23438136" className="cursor-pointer flex justify-around gap-x-2 w-full max-w-sm p-6 bg-green-100 border-2 border-green-200 rounded-lg shadow hover:bg-gray-100">
          ...
          <div>
            ...
            <h5 className="mb-2 text-3xl font-bold tracking-tight text-[#007c7c]">NDRF</h5>

            <a href='tel:011-23438136' className="font-normal text-xl md:text-2xl text-gray-500">011-23438136</a>
      ...
      <div className='hidden lg:flex md:flex-row flex-col flex-wrap w-full justify-around'>
        ...
        <div className="relative inline-block group">
          ...
          <a href=' ' class="relative inline-flex items-center justify-start px-8 py-3 overflow-hidden font-medium transition-all bg-green-200 rounded hover:bg-white group cursor-pointer">
      ...
      <div className='flex sm:flex-col flex-row flex-wrap lg:hidden gap-y-6 w-full'>
        ...
        {/* Essential Supplies */}
        <a href="#_" class="px-10 py-4 text-xl font-semibold text-center text-white transition duration-300 rounded-lg hover:from-green-600 hover:to-green-600 ease bg-gradient-to-br from-green-300 to-green-500 md:w-auto w-full">
          Essential Supplies
        </a>
      ...
      <div className="block w-full p-2 sm:p-6 border-2 bg-[#edffff] border-green-200 rounded-lg shadow hover:bg-gray-100">
        ...
        <div className='flex md:flex-row flex-col gap-6 items-center gap-x-16'>
          ...
          <div className='flex flex-col justify-between md:items-start items-center gap-y-3 md:gap-y-8'>
            ...
            <h5 className="mb-2 text-4xl font-bold tracking-tight capitalize text-[#007c7c]">Report For Help</h5>

            <p className='font-medium relative text-md text-gray-800 group-hover:text-black'>"Help those in need by reporting incidents on their behalf, ensuring timely aid reaches them through our network."</p>

            {/* Report Button */}
            <a href="#_" class="relative inline-flex items-center justify-center px-10 py-3 overflow-hidden font-medium text-white bg-[#007c7c] transition duration-300 ease-out border-2 rounded-full shadow-md group">
              ...
              <span class="absolute flex items-center justify-center w-full h-full text-white font-medium text-xl transition-all duration-300 transform group-hover:translate-x-full ease">Report Now</span>
      ...
      {AccordionData.map((data) => {
        return (
          ...
          <div id="accordion-open" data-accordion="open" key={data.id}>
            ...
            <div
              className={`${isOpen ? 'max-h-96 transition-max-h' : 'max-h-0'
